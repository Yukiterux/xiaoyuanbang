...
export function getTGovRuleInfo(params) {
  return api({
    method: 'get',
    url: appServer.template + 'getTGovRuleInfo',
    params: {...params}
  })
}
...
export function saveOrUpdateTGovRule(params) {
  return api({
    method: 'post',
    url: appServer.template + 'saveOrUpdateTGovRule',
    data: {...params}
  })
}
...
export function delTGovRule(params) {
  return api({
    method: 'post',
    url: appServer.template + 'delTGovRule',
    params: {...params}
  })
}
...
export function getAllRule(catalogoryCode) {
  return api({
    method: 'get',
    url: appServer.template + 'getTGovRuleAllAndCatelogry',
...
export function checkRuleNameCn(params) {
  return api({
    method: 'get',
    url: appServer.template + 'checkRuleNameCn',
    params: {...params}
  })
}
