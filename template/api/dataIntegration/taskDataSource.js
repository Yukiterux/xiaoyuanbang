...
// 获取数据表(不分页)
export function getAllTables(dataSourceId) {
  return api({
    method: 'get',
...
export function findAllTable(params) {
  return api({
    method: 'get',
    url: appServer.data + 'getAllTables',   //getAllTableByDataSourceId
    params: {...params}
  })
}
...
// 根据Id查询表信息
export function getCmColumnInfoByTableId(params) {
  return api({
    method: 'get',
    url: appServer.data + 'getCmColumnInfoByTableId',
    params: {...params}
  })
}
// 差数据源下表字段类型
