<template>
  <div class="list-apadd">
    ...
    <el-dialog title="获取申请查询" :close-on-click-modal="false" :visible.sync="ObtainVisable" width="50%" height="500px">
        <div class="bigBox">
          <el-form ref="form" :model="form" label-width="120px">
            <el-form-item label="产品名称">
              <el-input v-model="form.productName" placeholder="请输入" :disabled="isdisabledFn"></el-input>
            </el-form-item>
            <div>
              ...
              <el-form-item label="产品需求类型">
                <el-checkbox-group v-model="form.productTypeName" @change="checkChange">
                  <el-checkbox
...
export default {
  ...
  methods: {
    ...
    LookDemand(row) {
      ...
      const id = row.id;
      new Promise((resolve, reject) => {
        selectProductObtainById({ id: id })
          .then((res) => {
            this.form.productTypeName = res.data.resultData.productTypeArray;
            console.log(this.form.productTypeName);
