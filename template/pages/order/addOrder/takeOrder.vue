...
<div>
     <el-form ref="form"  label-width="180px">
        <el-form-item label="取货地址"  type="textarea" autosize>
          <el-autocomplete
          class="inline-input"
      ...
      <el-form-item label="取货电话" autosize>
            <el-input v-model="order.receiver_mobile"></el-input>
        </el-form-item>

  <hr>
  <el-form-item label="收货地址"  type="textarea" autosize>
          <el-autocomplete
          class="inline-input"
          v-model="order.buy_address"
          :fetch-suggestions="querySearch"
          placeholder="请输入内容"
          :trigger-on-focus="false"
        >
       ...
       <el-form-item label="收货备注地址"  type="textarea" autosize>
          <el-autocomplete
          class="inline-input"
          v-model="order.buy_remark_address"
          :fetch-suggestions="querySearch"
          placeholder="请输入内容"
          :trigger-on-focus="false"
        >
 ...
 <el-form-item label="收货电话" autosize>
            <el-input v-model="order.buy_mobile"></el-input>
        </el-form-item>
...
import payApi from '~/api/pay.js'
  export default {
    ...
    addOrder(){
      return orderApi.saveTakeOrder(this.order).then(res=>{
        if(res.data.flag){
                    this.$message({
                        message: '下单成功',
                        type: 'success'
