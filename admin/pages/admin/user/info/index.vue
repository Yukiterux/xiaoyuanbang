    ...
    <div class="block">
      <div class="con_header" :style="conhead">
        <el-row>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple filterItem">
              <label for="caseType" class="labelclass">用户是否已成为配送员</label>
              <el-select v-model="user.is_errands" placeholder="请选择">
                <el-option
        ...
        >
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button
                size="small"
                @click="changeUser('/admin/user/info/'+scope.row.id)"
              >修改用户</el-button>
