  ...
  <div width="1200">
    ...
    >
      ...
      <el-form-item
        ...
        autosize
      >
        <el-input v-model="item.receiver_mobile"></el-input>
      </el-form-item>
      ...
      <el-form-item
        ...
        autosize
      >
        <el-input v-model="item.receiver_address"></el-input>
      </el-form-item>
      ...
      <el-form-item
        ...
        autosize
      >
        <el-input v-model="item.receiver_remark_address"></el-input>
      </el-form-item>
      ...
      <el-form-item
        ...
        autosize
      >
        <el-input v-model="item.buy_address"></el-input>
      </el-form-item>
      <el-form-item
        label="购买备注地址"
        type="textarea"
        autosize
      >
        <el-input v-model="item.buy_remark_address"></el-input>
      </el-form-item>
      <el-form-item label="购买要求-所有人可见">
        <el-input v-model="item.buy_request"></el-input>
      </el-form-item>

      <el-form-item label="购买要求-仅配送者可见">
